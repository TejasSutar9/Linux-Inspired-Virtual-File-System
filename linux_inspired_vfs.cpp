...
void InitialiseUAREA()
{
   ...
   for(i = 0; i < MAXOPENFILES; i++)
   {
    ...
    printf("Linux-Inspired VFS : UAREA gets initialised successfully\n");
}
...
void InitialiseSuperBlock()
{
    ...
    printf("Linux-Inspired VFS : Super block gets initialised successfully\n");
}
...
void CreateDILB()
{
    ...
    printf("Linux-Inspired VFS : DILB created successfully\n");
}
...
{
    strcpy(bootobj.Information,"Booting process of Linux-Inspired VFS is done");
    ...
    printf("Linux-Inspired VFS : Auxillary data initialised successfully\n");
}
...
{
    printf("--------------------------------------------------\n");
    printf("---------- Linux-Inspired VFS Help Page ----------\n");
    printf("--------------------------------------------------\n");
    ...
    printf("exit   : It is used to terminate Linux-Inspired VFS\n");
...
void LsFile()
{
    ...
    printf("--------------------------------------------------\n");
    printf("------ Linux-Inspired VFS Files Information ------\n");
    printf("--------------------------------------------------\n");
    ...
    for(i = 0; i < MAXOPENFILES; i++)
    {
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcmp(uareaobj.UFDT[i]->ptrinode->FileName, name) == 0)
            {
                ...
                break;                  // for loop break (IMPORTANT)                
...
int main()
{
    ...
    printf("--------------------------------------------------\n");
    printf("----- Linux-Inspired VFS started succesfully -----\n");
    printf("--------------------------------------------------\n");
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            //Linux-Inspired VFS : > exit
            if(strcmp("exit",Command[0]) == 0)
            {
                printf("Thank you for using Linux-Inspired VFS\n");
            ...
            //Linux-Inspired VFS : > help
            else if(strcmp("help",Command[0]) == 0)
            {
                DisplayHelp();
            }

            //Linux-Inspired VFS : > clear
        ...
        {
            //Linux-Inspired VFS : > man ls
            if(strcmp("man",Command[0]) == 0)
            {
                ManPageDisplay(Command[1]);
            }

            //Linux-Inspired VFS : > unlink Demo.txt
            ...
            else if(strcmp("write",Command[0]) == 0)
            {
                ...
                {
                    printf("%d bytes gets successfuly written\n",iRet);
                }
            }
        ...
        {
            //Linux-Inspired VFS : > creat Ganesh.txt 3
            ...
            {
                printf("Error : Unable to create file because it is already present\n");
            }
